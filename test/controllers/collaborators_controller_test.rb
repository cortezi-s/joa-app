...
class CollaboratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collaborator" do
    assert_difference('Collaborator.count') do
      post collaborators_url, params: { collaborator: { linkedin: @collaborator.linkedin, message: @collaborator.message, name: @collaborator.name, role: @collaborator.role } }, as: :json
    end
  ...
  test "should update collaborator" do
    patch collaborator_url(@collaborator), params: { collaborator: { linkedin: @collaborator.linkedin, message: @collaborator.message, name: @collaborator.name, role: @collaborator.role } }, as: :json
    assert_response 200
  end
